...
class AppFixtures extends Fixture
{
    ...
    {
        // Create 20 vehicle entries with random VRMs and time_in values yesterday
        for ($i = 0; $i < 20; ++$i) {
            ...
            $vehicle = new Vehicle();
            $vehicle->setVrm('MA'.substr(rand(1990, 2025), -2).' '.chr(rand(65, 90)).chr(rand(65, 90)).chr(rand(65, 90)));
